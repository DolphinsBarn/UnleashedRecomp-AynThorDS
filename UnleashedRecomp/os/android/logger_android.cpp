...
void os::logger::Init()
{
    ...
    static constexpr char BuildVersion[] = "=== APK VERSION: 0.5.3-thor.3 (single-worker test) ===";
    static constexpr char BuildId[] = "ANDROID_BUILD_ID=0.5.3-thor.3-single-worker";
