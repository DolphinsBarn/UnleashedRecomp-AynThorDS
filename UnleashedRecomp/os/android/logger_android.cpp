...
void os::logger::Init()
{
    ...
    static constexpr char BuildVersion[] = "=== APK VERSION: 0.5.3-thor.2 (diagnostic build) ===";
    static constexpr char BuildId[] = "ANDROID_BUILD_ID=0.5.3-thor.2-guest-failure-trace";
